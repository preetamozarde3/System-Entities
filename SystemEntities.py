...
doc1 = nlp("I want to buy 40 apples tomorrow at 9 PM")
doc2 = nlp("I can send you the 10 invitations tomorrow at 3 PM on preetam@gmail.com")
doc3 = nlp("My name is Preetam and I am 23 years old. You can contact me on preetam@gmail.com")
doc4 = nlp("There is an urgent need of 5005 people for the event held at 9 PM on the 18th. Can you confirm that the availability on test@test.com if you are fifteen years of age or over?")
doc5 = nlp("You can contact me on preetam@gmail.com by tomorrow evening or Sunday at the latest if you are eighteen years or older.")
doc6 = nlp("Can you deliver thirteen apples and seventeen mangoes on 18th October?")
doc7 = nlp("The height of the cube is 113cm.")
doc8 = nlp("The price of the cube is 500 dollars.")
doc9 = nlp("The price of 55$ is completely reasonable.")
doc10 = nlp("Can you send me 65 $ tomorrow?")
doc11 = nlp("There are sixty five dollars to be paid to him.")
doc12 = nlp("Th apple costs 67 rupees.")
doc13 = nlp("The mangoes cost 65rupees.")
docs = [doc1, doc2, doc3, doc4, doc5, doc6, doc7, doc8, doc9, doc10, doc11, doc12, doc13]
